...
export function LogTimeline4({ logItems = DATA_LOGITEMS }: LogTimelineProps) {
  return (
    <Card className="p-4 shadow-md dark:shadow-sm">
      <div className="relative">
        {/* Full vertical line */}
        <div className="absolute top-0 bottom-0 left-[33.33%] transform -translate-x-1/2 w-0.5 bg-gray-300 dark:bg-gray-600" />
