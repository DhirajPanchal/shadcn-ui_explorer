...
export function LogTimeline3({ logItems = DATA_LOGITEMS }: LogTimelineProps) {
  return (
    <Card className="p-4 shadow-md dark:shadow-sm">
      <div className="relative">
        {/* Line ends at last dot */}
        <div
          className="absolute left-1/3 transform -translate-x-1/2 w-0.5 bg-gray-300 dark:bg-gray-600 transition-all duration-500"
          style={{
            top: "1.25rem", // match padding top of timeline
            bottom: `${(logItems.length - 1) * 5.5}rem`, // estimate offset from last dot
          }}
        />
